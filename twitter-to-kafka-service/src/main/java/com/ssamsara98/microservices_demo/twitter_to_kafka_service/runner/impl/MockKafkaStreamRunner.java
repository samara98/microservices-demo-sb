package com.ssamsara98.microservices_demo.twitter_to_kafka_service.runner.impl;

import com.ssamsara98.microservices_demo.config.TwitterToKafkaServiceConfigData;
import com.ssamsara98.microservices_demo.twitter_to_kafka_service.exception.TwitterToKafkaServiceException;
import com.ssamsara98.microservices_demo.twitter_to_kafka_service.listener.TwitterKafkaStatusListener;
...
public class MockKafkaStreamRunner implements StreamRunner {
	...
	public void start() throws TwitterException {
		System.out.println("---===---");
		LOG.info("Keyword -->> {}",twitterToKafkaServiceConfigData.getTwitterKeywords().toString());
		System.out.println("---===---");
